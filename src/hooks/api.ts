...
import { getSeats, postReservation, postPayment, deletePayment, checkPayment } from "apis";
...
export function useReservation() {
  ...
  async function createReservation({ name, email, seats }) {
    try {
...
export function usePayment() {
  ...
  async function cancelPayment({ reservationId, reason }) {
    try {
